    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          card-classes="h-100"
          title="Twitch Posts"
          icon="/dist/media/svg/brand-logos/twitch.svg"
          content="$500.00"
          color="success"
          arrow="Up-right"
          footer-data="+40.5%"
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          ...
          icon="/dist/media/svg/brand-logos/twitter.svg"
          content="807k"
          color="success"
          arrow="Up-right"
          footer-data="+17.62%"
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          ...
          icon="/dist/media/svg/brand-logos/spotify.svg"
          content="1,073"
          color="danger"
          arrow="Down-left"
          footer-data="+10.45%"
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          ...
          icon="/dist/media/svg/brand-logos/pinterest-p.svg"
          content="97"
          color="success"
          arrow="Up-right"
          footer-data="+26.1%"
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          ...
          icon="/dist/media/svg/brand-logos/github.svg"
          content="4,109"
          color="danger"
          arrow="Down-left"
          footer-data="+32.8%"
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          ...
          icon="/dist/media/svg/brand-logos/youtube-3.svg"
          content="354"
          color="success"
          arrow="Up-right"
          footer-data="+29.45%"
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          ...
          icon="/dist/media/svg/brand-logos/telegram.svg"
          content="566"
          color="success"
          arrow="Up-right"
          footer-data="+11.4%"
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="card h-100">
        <Card2
          card-classes="h-100"
          title="Reddit Awards"
          icon="/dist/media/svg/brand-logos/reddit.svg"
          content="2.1M"
          color="success"
          arrow="Up-right"
          footer-data="-46.7%"
