    ...
    <div class="py-5">
      <div class="rounded border p-10 pb-0 d-flex flex-wrap">
        <div class="symbol-group symbol-hover">
          ...
          <div class="symbol symbol-circle symbol-50px mb-10">
            <img
              src="/dist/media/avatars/150-2.jpg"
              alt=""
            >
          </div>
    ...
    <div class="py-5">
      ...
      >
        ...
        <div class="symbol-group symbol-hover">
          ...
          <div class="symbol symbol-circle symbol-50px">
            <img
              src="assets/dist/media/avatars/150-2.jpg"
              alt=""
            >
          </div>
          ...
          <div class="symbol symbol-circle symbol-50px">
            <img
              src="assets/dist/media/avatars/150-3.jpg"
              alt=""
            >
          </div>
          ...
          <div class="symbol symbol-circle symbol-50px">
            <img
              src="assets/dist/media/avatars/150-4.jpg"
              alt=""
            >
          </div>
          ...
          <div class="symbol symbol-circle symbol-50px">
            <img
              src="assets/dist/media/avatars/150-5.jpg"
              alt=""
            >
          </div>
          ...
          <div class="symbol symbol-circle symbol-50px">
            <img
              src="assets/dist/media/avatars/150-6.jpg"
              alt=""
            >
          </div>
        </div>
