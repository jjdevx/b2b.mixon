<template>
  ...
  <div class="py-10">
      ...
      <div class="rounded border d-flex flex-wrap p-10">
        ...
        >
          <div class="d-flex flex-column flex-center w-150px me-10 mb-5">
            ...
            >
              <inline-svg src="/dist/media/icons/duotone/Design/Color-profile.svg" />
            </span>
    ...
    <div class="py-5">
      ...
      >
        {{`<span
          class="svg-icon svg-icon-2x svg-icon-white"
        ><svg>...</svg></span>
        <span
        ...
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-100"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-200"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-300"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-400"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-500"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-600"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-700"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-800"
        ><svg>...</svg></span>
        <span
          class="svg-icon svg-icon-2x svg-icon-gray-900"
        ><svg>...</svg></span>`}}
      </CodeHighlighter>
    </div>
    <!--end::Code-->
