...
import {
  example3Html,
  example3Js
} from "@/metronic/views/resources/documentation/forms/vee-validate/codes";
import CodeHighlighter2 from "@/metronic/components/highlighters/CodeHighlighter2.vue";
