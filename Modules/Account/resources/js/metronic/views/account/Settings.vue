      ...
      <div class="card-body border-top p-9">
        ...
        >
          <span class="svg-icon svg-icon-2tx svg-icon-primary me-4">
            <inline-svg src="/dist/media/icons/duotone/Design/Select.svg" />
          </span>
        ...
        <div class="py-2">
          ...
          <div class="d-flex flex-stack">
            <div class="d-flex">
              <img
                src="/dist/media/svg/brand-logos/github.svg"
                class="w-30px me-6"
                alt=""
              >
          ...
          <div class="d-flex flex-stack">
            <div class="d-flex">
              <img
                src="/dist/media/svg/brand-logos/slack-icon.svg"
                class="w-30px me-6"
                alt=""
              >
        ...
        <div class="card-body border-top p-9">
          ...
          >
            <span class="svg-icon svg-icon-2tx svg-icon-warning me-4">
              <inline-svg src="/dist/media/icons/duotone/Code/Warning-1-circle.svg" />
            </span>
            <!--begin::Wrapper-->
            <div class="d-flex flex-stack flex-grow-1 ">
              <!--begin::Content-->
...
export default defineComponent({
  ...
  setup() {
    ...
    const removeImage = () => {
      profileDetails.value.avatar = "/dist/media/avatars/blank.png";
    };
